...
instance Registers ¶Prelude®¶.¶PrimMakeUndefined®¶ Registers.Registers_;
								       
instance Registers ¶Prelude®¶.¶PrimDeepSeqCond®¶ Registers.Registers_;
								     
instance Registers ¶Prelude®¶.¶PrimMakeUninitialized®¶ Registers.Registers_;
...
instance Registers ¶Prelude®¶.¶PrimMakeUndefined®¶ Registers.Registers;
								      
instance Registers ¶Prelude®¶.¶PrimDeepSeqCond®¶ Registers.Registers;
								    
instance Registers ¶Prelude®¶.¶PrimMakeUninitialized®¶ Registers.Registers;
									  
Registers._Registers :: (¶Prelude®¶.¶IsModule®¶ _m__ _c__) =>
			_m__ (¶Prelude®¶.¶Tuple2®¶ Registers.Registers_ Registers.Registers);
											    
instance Registers ¶Connectable®¶.¶Connectable®¶ Registers.Registers Registers.Registers_;
											 
instance Registers ¶Connectable®¶.¶Connectable®¶ Registers.Registers_ Registers.Registers;
