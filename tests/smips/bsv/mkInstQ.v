...
module mkInstQ(CLK,
  ...
  wire [31 : 0] mod__mod__deq___first___data_$IN_WRITE,
  ...
  wire [31 : 0] mod__mod__enq___enq__data_$IN_WRITE,
  ...
  wire mod__regs_mod__mod__read___req__data_$IN_EN_WRITE,
       mod__regs_mod__mod__read___req__data_$IN_WRITE,
  ...
  wire [31 : 0] mod__regs_mod__mod__read___resp___data_$IN_WRITE,
  ...
  wire [32 : 0] mod__regs_mod__mod__write___data_$IN_WRITE,
  ...
  wire mod__regs_mod__rf_mod__read___req__data_$IN_EN_WRITE,
       mod__regs_mod__rf_mod__read___req__data_$IN_WRITE,
  ...
  wire [31 : 0] mod__regs_mod__rf_mod__read___resp___data_$IN_WRITE,
  ...
  wire [32 : 0] mod__regs_mod__rf_mod__write___data_$IN_WRITE,
  ...
  wire [31 : 0] mod__regs_mod__rf_rf$READ_RESP_READ,
		mod__regs_mod__rf_rf$WRITE_DATA_WRITE;
  wire mod__regs_mod__rf_rf$READ_REQ_WRITE,
       mod__regs_mod__rf_rf$WRITE_EN_WRITE,
  ...
  wire [1 : 0] IF_0_CONCAT_mod__head__read__9_2_PLUS_1_6_ULE__ETC__q2,
	       IF_0_CONCAT_mod__tail__read__8_0_PLUS_1_5_ULE__ETC__q1,
  ...
  // submodule mod__head
  mkReg #( /*width*/ 32'd1,  /*init*/ 1'd0) mod__head(.CLK(CLK),
						      .RST_N(RST_N),
  ...
  mkWire #( /*width*/ 32'd32) mod__mod__deq___first___data_(.IN_WRITE(mod__mod__deq___first___data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd32) mod__mod__enq___enq__data_(.IN_WRITE(mod__mod__enq___enq__data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd1) mod__regs_mod__mod__read___req__data_(.IN_WRITE(mod__regs_mod__mod__read___req__data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd32) mod__regs_mod__mod__read___resp___data_(.IN_WRITE(mod__regs_mod__mod__read___resp___data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd33) mod__regs_mod__mod__write___data_(.IN_WRITE(mod__regs_mod__mod__write___data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd1) mod__regs_mod__rf_mod__read___req__data_(.IN_WRITE(mod__regs_mod__rf_mod__read___req__data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd32) mod__regs_mod__rf_mod__read___resp___data_(.IN_WRITE(mod__regs_mod__rf_mod__read___resp___data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd33) mod__regs_mod__rf_mod__write___data_(.IN_WRITE(mod__regs_mod__rf_mod__write___data_$IN_WRITE),
  ...
  // submodule mod__tail
  mkReg #( /*width*/ 32'd1,  /*init*/ 1'd0) mod__tail(.CLK(CLK),
						      .RST_N(RST_N),
