...
//
// On Wed Aug  3 12:04:20 EDT 2011
//
// Method conflict info:
// Method: mem_instReqQ_notEmpty__read
// Conflict-free: mem_instReqQ_notEmpty__read,
// 	       mem_instReqQ_first__read,
// 	       mem_instReqQ_deq__read,
// 	       mem_instQ_notFull__read,
// 	       mem_instQ_enq_write,
// 	       mem_dataReqQ_notEmpty__read,
// 	       mem_dataReqQ_first__read,
// 	       mem_dataReqQ_deq__read,
// 	       mem_dataQ_notFull__read,
// 	       mem_dataQ_enq_write
//
// Method: mem_instReqQ_first__read
// Conflict-free: mem_instReqQ_notEmpty__read,
// 	       mem_instReqQ_first__read,
// 	       mem_instReqQ_deq__read,
// 	       mem_instQ_notFull__read,
...
// 	       mem_dataQ_notFull__read,
// 	       mem_dataQ_enq_write
// Conflicts: mem_instReqQ_deq__read
//
// Method: mem_instQ_notFull__read
// Conflict-free: mem_instReqQ_notEmpty__read,
// 	       mem_instReqQ_first__read,
// 	       mem_instReqQ_deq__read,
// 	       mem_instQ_notFull__read,
...
// 	       mem_dataQ_notFull__read,
// 	       mem_dataQ_enq_write
// Conflicts: mem_instQ_enq_write
//
// Method: mem_dataReqQ_notEmpty__read
// Conflict-free: mem_instReqQ_notEmpty__read,
// 	       mem_instReqQ_first__read,
// 	       mem_instReqQ_deq__read,
// 	       mem_instQ_notFull__read,
...
// 	       mem_dataQ_enq_write
//
// Method: mem_dataReqQ_first__read
// Conflict-free: mem_instReqQ_notEmpty__read,
// 	       mem_instReqQ_first__read,
// 	       mem_instReqQ_deq__read,
// 	       mem_instQ_notFull__read,
...
// 	       mem_dataQ_notFull__read,
// 	       mem_dataQ_enq_write
// Conflicts: mem_dataReqQ_deq__read
//
// Method: mem_dataQ_notFull__read
// Conflict-free: mem_instReqQ_notEmpty__read,
// 	       mem_instReqQ_first__read,
// 	       mem_instReqQ_deq__read,
// 	       mem_instQ_notFull__read,
...
module mkCore(CLK,
  ...
  // ports of submodule mod__mem___dataQ__enq__data_
  wire [31 : 0] mod__mem___dataQ__enq__data_$IN_WRITE,
		mod__mem___dataQ__enq__data_$OUT_READ;
  wire mod__mem___dataQ__enq__data_$IN_EN_WRITE;

  // ports of submodule mod__mem___dataQ__enq__en_
  wire mod__mem___dataQ__enq__en_$IN_EN_WRITE,
       mod__mem___dataQ__enq__en_$OUT_READ;

  // ports of submodule mod__mem___dataQ__notFull___data_
  wire mod__mem___dataQ__notFull___data_$IN_EN_WRITE,
       mod__mem___dataQ__notFull___data_$IN_WRITE,
       mod__mem___dataQ__notFull___data_$OUT_READ;

  // ports of submodule mod__mem___dataReqQ__deq__data_
  wire mod__mem___dataReqQ__deq__data_$IN_EN_WRITE,
       mod__mem___dataReqQ__deq__data_$OUT_READ;

  // ports of submodule mod__mem___dataReqQ__first___data_
  wire [64 : 0] mod__mem___dataReqQ__first___data_$IN_WRITE,
		mod__mem___dataReqQ__first___data_$OUT_READ;
  wire mod__mem___dataReqQ__first___data_$IN_EN_WRITE;

  // ports of submodule mod__mem___dataReqQ__notEmpty___data_
  wire mod__mem___dataReqQ__notEmpty___data_$IN_EN_WRITE,
       mod__mem___dataReqQ__notEmpty___data_$IN_WRITE,
       mod__mem___dataReqQ__notEmpty___data_$OUT_READ;

  // ports of submodule mod__mem___instQ__enq__data_
  wire [31 : 0] mod__mem___instQ__enq__data_$IN_WRITE,
		mod__mem___instQ__enq__data_$OUT_READ;
  wire mod__mem___instQ__enq__data_$IN_EN_WRITE;

  // ports of submodule mod__mem___instQ__enq__en_
  wire mod__mem___instQ__enq__en_$IN_EN_WRITE,
       mod__mem___instQ__enq__en_$OUT_READ;

  // ports of submodule mod__mem___instQ__notFull___data_
  wire mod__mem___instQ__notFull___data_$IN_EN_WRITE,
       mod__mem___instQ__notFull___data_$IN_WRITE,
       mod__mem___instQ__notFull___data_$OUT_READ;

  // ports of submodule mod__mem___instReqQ__deq__data_
  wire mod__mem___instReqQ__deq__data_$IN_EN_WRITE,
       mod__mem___instReqQ__deq__data_$OUT_READ;

  // ports of submodule mod__mem___instReqQ__first___data_
  wire [31 : 0] mod__mem___instReqQ__first___data_$IN_WRITE,
		mod__mem___instReqQ__first___data_$OUT_READ;
  wire mod__mem___instReqQ__first___data_$IN_EN_WRITE;

  // ports of submodule mod__mem___instReqQ__notEmpty___data_
  wire mod__mem___instReqQ__notEmpty___data_$IN_EN_WRITE,
       mod__mem___instReqQ__notEmpty___data_$IN_WRITE,
  ...
  // submodule mod__mem___dataQ__enq__data_
  mkWire #( /*width*/ 32'd32) mod__mem___dataQ__enq__data_(.IN_WRITE(mod__mem___dataQ__enq__data_$IN_WRITE),
							   .IN_EN_WRITE(mod__mem___dataQ__enq__data_$IN_EN_WRITE),
							   .OUT_READ(mod__mem___dataQ__enq__data_$OUT_READ));

  // submodule mod__mem___dataQ__enq__en_
  mkPulse mod__mem___dataQ__enq__en_(.IN_EN_WRITE(mod__mem___dataQ__enq__en_$IN_EN_WRITE),
				     .OUT_READ(mod__mem___dataQ__enq__en_$OUT_READ));

  // submodule mod__mem___dataQ__notFull___data_
  mkWire #( /*width*/ 32'd1) mod__mem___dataQ__notFull___data_(.IN_WRITE(mod__mem___dataQ__notFull___data_$IN_WRITE),
							       .IN_EN_WRITE(mod__mem___dataQ__notFull___data_$IN_EN_WRITE),
							       .OUT_READ(mod__mem___dataQ__notFull___data_$OUT_READ));

  // submodule mod__mem___dataReqQ__deq__data_
  mkPulse mod__mem___dataReqQ__deq__data_(.IN_EN_WRITE(mod__mem___dataReqQ__deq__data_$IN_EN_WRITE),
					  .OUT_READ(mod__mem___dataReqQ__deq__data_$OUT_READ));

  // submodule mod__mem___dataReqQ__first___data_
  mkWire #( /*width*/ 32'd65) mod__mem___dataReqQ__first___data_(.IN_WRITE(mod__mem___dataReqQ__first___data_$IN_WRITE),
								 .IN_EN_WRITE(mod__mem___dataReqQ__first___data_$IN_EN_WRITE),
								 .OUT_READ(mod__mem___dataReqQ__first___data_$OUT_READ));

  // submodule mod__mem___dataReqQ__notEmpty___data_
  mkWire #( /*width*/ 32'd1) mod__mem___dataReqQ__notEmpty___data_(.IN_WRITE(mod__mem___dataReqQ__notEmpty___data_$IN_WRITE),
								   .IN_EN_WRITE(mod__mem___dataReqQ__notEmpty___data_$IN_EN_WRITE),
								   .OUT_READ(mod__mem___dataReqQ__notEmpty___data_$OUT_READ));

  // submodule mod__mem___instQ__enq__data_
  mkWire #( /*width*/ 32'd32) mod__mem___instQ__enq__data_(.IN_WRITE(mod__mem___instQ__enq__data_$IN_WRITE),
							   .IN_EN_WRITE(mod__mem___instQ__enq__data_$IN_EN_WRITE),
							   .OUT_READ(mod__mem___instQ__enq__data_$OUT_READ));

  // submodule mod__mem___instQ__enq__en_
  mkPulse mod__mem___instQ__enq__en_(.IN_EN_WRITE(mod__mem___instQ__enq__en_$IN_EN_WRITE),
				     .OUT_READ(mod__mem___instQ__enq__en_$OUT_READ));

  // submodule mod__mem___instQ__notFull___data_
  mkWire #( /*width*/ 32'd1) mod__mem___instQ__notFull___data_(.IN_WRITE(mod__mem___instQ__notFull___data_$IN_WRITE),
							       .IN_EN_WRITE(mod__mem___instQ__notFull___data_$IN_EN_WRITE),
							       .OUT_READ(mod__mem___instQ__notFull___data_$OUT_READ));

  // submodule mod__mem___instReqQ__deq__data_
  mkPulse mod__mem___instReqQ__deq__data_(.IN_EN_WRITE(mod__mem___instReqQ__deq__data_$IN_EN_WRITE),
					  .OUT_READ(mod__mem___instReqQ__deq__data_$OUT_READ));

  // submodule mod__mem___instReqQ__first___data_
  mkWire #( /*width*/ 32'd32) mod__mem___instReqQ__first___data_(.IN_WRITE(mod__mem___instReqQ__first___data_$IN_WRITE),
								 .IN_EN_WRITE(mod__mem___instReqQ__first___data_$IN_EN_WRITE),
								 .OUT_READ(mod__mem___instReqQ__first___data_$OUT_READ));

  // submodule mod__mem___instReqQ__notEmpty___data_
  mkWire #( /*width*/ 32'd1) mod__mem___instReqQ__notEmpty___data_(.IN_WRITE(mod__mem___instReqQ__notEmpty___data_$IN_WRITE),
