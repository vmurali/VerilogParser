...
module mkInstReqQ(CLK,
  ...
  wire [2 : 0] mod__regs_mod__mod__read___req__data_$IN_WRITE,
  ...
  wire [2 : 0] mod__regs_mod__rf_mod__read___req__data_$IN_WRITE,
  ...
  wire [2 : 0] mod__regs_mod__rf_rf$READ_REQ_WRITE,
  ...
  wire [2 : 0] mod__head__read__7_PLUS_1___d52,
  ...
  // submodule mod__head
  mkReg #( /*width*/ 32'd3,  /*init*/ 3'd0) mod__head(.CLK(CLK),
						      .RST_N(RST_N),
  ...
  mkWire #( /*width*/ 32'd3) mod__regs_mod__mod__read___req__data_(.IN_WRITE(mod__regs_mod__mod__read___req__data_$IN_WRITE),
  ...
  mkWire #( /*width*/ 32'd3) mod__regs_mod__rf_mod__read___req__data_(.IN_WRITE(mod__regs_mod__rf_mod__read___req__data_$IN_WRITE),
  ...
  // submodule mod__tail
  mkReg #( /*width*/ 32'd3,  /*init*/ 3'd0) mod__tail(.CLK(CLK),
						      .RST_N(RST_N),
